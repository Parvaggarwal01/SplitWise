...
The app provides a **Download report** button after import. It downloads `import-report.pdf`, generated by the backend from the latest import, listing every anomaly detected and the action taken. A Markdown version is also available at `/api/imports/latest/report.md`.
